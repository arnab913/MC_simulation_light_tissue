...
%%  No gradient model, reflectance plot over x axis , y=0
% 
...
for kk = ks
    ...
    % Recompute bin centers (same for all k if xEdges,yEdges are global)
    ...
    plot(xCenters, R_line, 'DisplayName', sprintf('k = %d', kk));
end
...
title('Diffuse reflectance along central x-axis (y \approx 0)');
legend('show');
grid on;
